...
def video_worker(task, msg_queue):
    ...
    # --- CORRUPTION TOLERANCE COUNTERS ---
    consecutive_errors = 0
    MAX_ERRORS = 50 # How many bad frames to skip before giving up
    ...
    while True:
        ...
        # --- NEW CORRUPTION HANDLING LOGIC ---
        if not ret:
            consecutive_errors += 1
            if consecutive_errors > MAX_ERRORS:
                # We truly hit the end or a massive dead zone
                break
        ...
        # If we got here, the frame is good
        consecutive_errors = 0 
...
class ArchivistPro(ctk.CTk):
    def __init__(self):
        ...
        self.title("Archivist Pro v3.8 - CORRUPTION RECOVERY")
    ...
    def _setup_layout(self):
        ...
        ctk.CTkLabel(self.sidebar, text="ARCHIVIST PRO v3.8", font=("Impact", 28)).pack(pady=(20, 10))
    ...
    def _build_settings(self, parent):
        ...
        # Hidden manual res input (preset overrides it)

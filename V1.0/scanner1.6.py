...
class ArchivistPro(ctk.CTk):
    def __init__(self):
        ...
        self.title("Archivist Pro v1.6 - Stable Edition")
    ...
    def _setup_layout(self):
        ...
        ctk.CTkLabel(self.sidebar, text="ARCHIVIST PRO v1.6", font=("Impact", 28)).pack(pady=(20, 10))
    ...
    def start_processing(self):
        ...
        num_cores = 15 
        print(f"--- STARTING POOL WITH {num_cores} CORES ---")

...
# --- CONFIGURATION ---
# [cite_start]Ensure this matches your installation path [cite: 42]
...
def video_worker(task, msg_queue):
    ...
    # 1. Map Labels to Categories for Folder Sorting
    label_map = {}
    ...
    # Base folder: Archived_Scans/Subject/Video_Name/
    ...
    while True:
        ...
        if frame_count % skip_interval == 0:
            ...
            # Update Progress Bar (every ~5% or so to save resources)
            ...
            # Live Preview (Every 10th processed frame)
            ...
            if hit_found:
                ...
                # --- NEW SAVING LOGIC ---
                # Determine Category (CRITICAL, WARNING, or MINOR)
                category_folder = label_map.get(label_found.upper(), "UNCATEGORIZED")
                
                # Final Path: .../Video_Name/CRITICAL/
...
class ArchivistPro(ctk.CTk):
    def __init__(self):
        ...
        self.title("Archivist Pro v1.2")
        self.geometry("1400x900")

        self.task_stack = []
        self.prog_bars = {} 
        self.pool = None  # To store the active process pool
    ...
    def _setup_layout(self):
        ...
        ctk.CTkLabel(self.sidebar, text="ARCHIVIST PRO v1.2", font=("Impact", 28)).pack(pady=(20, 10))
        ...
        ctk.CTkButton(self.sidebar, text="Clear Queue", command=self.clear_queue, fg_color="#e67e22").pack(fill="x", padx=20, pady=5)
    ...
    def generate_pdf(self, results):
        ...
        pdf.cell(0, 10, "Archivist Pro v1.2 Report", ln=1, align='C')
        pdf.ln(10)

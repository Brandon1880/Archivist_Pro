...
# ==========================================
#        WORKER ENGINE (ANTI-FREEZE)
# ==========================================
def video_worker(task, msg_queue, worker_idx):
    import onnxruntime as ort
    
    # --- SAFETY BLOCK START ---
    # We wrap EVERYTHING in try/finally to ensure the stop signal is ALWAYS sent
    try:
        ...
        except: return # Exit triggers finally block
        ...
        # --- DEAD MAN'S SWITCH ---
        # This GUARANTEES the worker stops and the main queue continues
...
class ArchivistPro(ctk.CTk):
    def __init__(self):
        ...
        self.title("Archivist Pro v4.6.1 - ANTI-FREEZE")
    ...
    def _setup_layout(self):
        ...
        ctk.CTkLabel(self.sidebar, text="ARCHIVIST PRO v4.6", font=("Impact", 28)).pack(pady=20)
        ...
        try:
            ...
            while not self.msg_queue.empty() and cnt < 100:
                ...
                if m['type'] == 'GRID_PREVIEW' and m['idx'] in self.grid_slots:
                    ...
                    # DECREMENT CHUNK COUNTER (Safety for Focus Mode)

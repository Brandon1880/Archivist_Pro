...
class ArchivistPro(ctk.CTk):
    def __init__(self):
        ...
        self.title("Archivist Pro v4.0.6 - SERIAL MODE FIXED")
    ...
    def _setup_layout(self):
        ...
        ctk.CTkLabel(self.sidebar, text="ARCHIVIST PRO v4.0.6", font=("Impact", 28)).pack(pady=(20, 10))
    ...
    def check_messages(self):
        try:
            while not self.msg_queue.empty():
                ...
                # This is the Key Fix. We track how many workers are active.
                ...
                elif msg['type'] == 'TICK' and m['video'] in self.prog_bars:
